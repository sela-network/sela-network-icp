...
import { idlFactory } from './ios_notifications_www.did.js';
export { idlFactory } from './ios_notifications_www.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_IOS_NOTIFICATIONS_WWW;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ios_notifications_www.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ios_notifications_www canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ios_notifications_www.did.js")._SERVICE>}
 */
export const ios_notifications_www = createActor(canisterId);

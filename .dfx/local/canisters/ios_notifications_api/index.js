...
import { idlFactory } from './ios_notifications_api.did.js';
export { idlFactory } from './ios_notifications_api.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_IOS_NOTIFICATIONS_API;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ios_notifications_api.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ios_notifications_api canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ios_notifications_api.did.js")._SERVICE>}
 */
export const ios_notifications_api = createActor(canisterId);
